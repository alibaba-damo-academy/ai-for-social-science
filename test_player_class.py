...
class user_player_class(simple_greedy_agent):

    def __init__(self, args, agent_name='', lowest_value=0, highest_value=10):
        super(user_player_class, self).__init__(args, agent_name, lowest_value, highest_value)

    def get_custom_agent_name(self):
        return self.agent_name
    
    def generate_action(self, obs):
        # print('self', self)
        # print('obs', obs)
        true_value = obs['true_value_list'][-1]
