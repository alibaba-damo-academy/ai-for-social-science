...
class mini_env_ver_user_info(dynamic_env):
    def __init__(self, round, item_num, mini_env_iters, agent_num, args, policy, set_env=None, init_from_args=True,
        ...
        super(mini_env_ver_user_info).__init__()
    ...
    def agent_info_communication(self,agent_list):
        # to be added
    ...
    def step(self, agents_list=None):
        ...
        for agent_name in env.agent_iter():
            ...
            if agent_name == env.agents[0] :
                ...
                # agent information communication
                self.agent_info_communication()
