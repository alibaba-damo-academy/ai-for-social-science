...
from customed_env_auction_deep_continuous import *
...
parser.add_argument('--folder_name', type=str, default='results/deep_SAC',
...
#         action, _, _ = algo.get_policy(agent).compute_single_action(observation)
...
def run_same_policy(args, stop,algorithm="A2C",estimate_frequent=100):
