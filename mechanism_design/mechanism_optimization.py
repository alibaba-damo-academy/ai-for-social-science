...
def main(args):
    ...
    deep_payment_rule = deep_payment(args,agent_num=args.player_num)

    #deep_payment_rule.close_grad()

    deep_mechanism.assign_payment_net(payment_net=deep_payment_rule)
