...
#
python auction_bidding_simulate.py --mechanism 'second_price' --exp_id 222  --folder_name 'new_diff_v' \
--bidding_range 60 --valuation_range 10 --env_iters 16000000  --overbid True \
