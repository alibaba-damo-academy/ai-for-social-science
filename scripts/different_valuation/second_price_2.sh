...
#
python auction_bidding_simulate.py --mechanism 'second_price' --exp_id 22  --folder_name 'diff_v' \
--bidding_range 40 --valuation_range 10 --env_iters 16000000 --overbid True \
