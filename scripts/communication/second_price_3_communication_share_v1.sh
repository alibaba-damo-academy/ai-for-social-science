...
# no overbid
python auction_bidding_simulate.py --mechanism 'second_price' --exp_id 20  --folder_name 'commu_v1' \
--bidding_range 60 --valuation_range 10 --env_iters 80000000  --record_efficiency 1 \
...
--cm_id 1 --cm_id 2 \
--inner_cooperate 1 --overbid True --cooperate_pay_limit 1 \
