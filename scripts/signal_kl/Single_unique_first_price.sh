...
#python auction_bidding_simulate.py --mechanism 'first_price' --exp_id 1  --folder_name 'kl_single_u' \
...
#--value_generator_mode 'single_u' --public_signal_range 10


python auction_bidding_simulate.py --mechanism 'first_price' --exp_id 3  --folder_name 'kl_single_u' \
--bidding_range 20 --valuation_range 10 --env_iters 3000000 \
...
python auction_bidding_simulate.py --mechanism 'first_price' --exp_id 4  --folder_name 'kl_single_u' \
--bidding_range 20 --valuation_range 10 --env_iters 3000000 \
...
python auction_bidding_simulate.py --mechanism 'first_price' --exp_id 44  --folder_name 'kl_single_u' \
...
python auction_bidding_simulate.py --mechanism 'first_price' --exp_id 33  --folder_name 'kl_single_u' \
--bidding_range 20 --valuation_range 10 --env_iters 20000000 \
