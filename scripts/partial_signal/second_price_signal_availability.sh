...
python auction_bidding_simulate.py --mechanism 'second_price' --exp_id 1 \
--folder_name 'partial_signal/second_price' \
...
python auction_bidding_simulate.py --mechanism 'second_price' --exp_id 2 \
--folder_name 'partial_signal/second_price' \
--bidding_range 20 --valuation_range 10 --env_iters 1000000  \
--record_efficiency 0 --estimate_frequent 200000 --revenue_averaged_stamp 20000 \
--exploration_epoch 100000 --player_num 4 --public_signal 1 \
...
python auction_bidding_simulate.py --mechanism 'second_price' --exp_id 3 \
--folder_name 'partial_signal/second_price' \
--bidding_range 20 --valuation_range 10 --env_iters 1000000  \
--record_efficiency 0 --estimate_frequent 200000 --revenue_averaged_stamp 20000 \
--exploration_epoch 100000 --player_num 4 --public_signal 1 \
...
python auction_bidding_simulate.py --mechanism 'second_price' --exp_id 4 \
--folder_name 'partial_signal/second_price' \
--bidding_range 20 --valuation_range 10 --env_iters 1000000  \
--record_efficiency 0 --estimate_frequent 200000 --revenue_averaged_stamp 20000 \
--exploration_epoch 100000 --player_num 4 --public_signal 1 \
