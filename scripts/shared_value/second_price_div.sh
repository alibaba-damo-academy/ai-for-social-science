...
#
python auction_bidding_simulate.py --mechanism 'second_price' --exp_id 2002  --folder_name 'shared_value' \
--bidding_range 60 --valuation_range 10 --env_iters 10000000  --record_efficiency 1 \
